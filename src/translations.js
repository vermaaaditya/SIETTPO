export const translations = {
  en: {
    ...
    login: {
      ...
      title: 'Student Login',
      subtitle: 'Sign in with your institution roll number and TPC password.',
      errorMsg:
  ...
  hi: {
    ...
    login: {
      ...
      title: 'छात्र लॉगिन',
      subtitle: 'अपने संस्थान के रोल नंबर और TPC पासवर्ड से साइन इन करें।',
      errorMsg: 'गलत रोल नंबर या पासवर्ड। कृपया पुनः प्रयास करें या TPO से संपर्क करें।',
      successMsg: 'लॉगिन सफल! आपके डैशबोर्ड पर रीडायरेक्ट किया जा रहा है…',
