export const translations = {
  en: {
    ...
    login: {
      ...
      collegeEmailPlaceholder: 'name@siet....',
      rollNumberLabel: 'Roll Number',
      rollNumberPlaceholder: 'e.g. 2210001',
      courseLabel: 'Course',
      coursePlaceholder: 'e.g. B.Tech',
      branchLabel: 'Branch',
      branchPlaceholder: 'e.g. CSE (AI & ML)',
      batchLabel: 'Batch',
  ...
  hi: {
    ...
    login: {
      ...
      rollNumberPlaceholder: 'जैसे 2210001',
      courseLabel: 'कोर्स',
      coursePlaceholder: 'जैसे B.Tech',
      branchLabel: 'शाखा',
      branchPlaceholder: 'जैसे CSE (AI & ML)',
      batchLabel: 'बैच',
